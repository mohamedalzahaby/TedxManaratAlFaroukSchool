...
<div class="container"style="margin-top:100px">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"style="margin-bottom:30px;font-size:30px;">{{ __('Login') }}</div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="background-color:#e62b1e;border-radius:10px ">
                                    {{ __('Login') }}
                                </button>
