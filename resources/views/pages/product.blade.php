...
<div class="row margin-5 no-margin-rl no-margin-bottom">
  <div class="col-md-5 no-padding-rl">
    <div class="row text-center">
      <a href="{{'addNewProduct'}}" class="btn btn-outline-base-color sm-btn-medium btn-large no-margin-rl"> <h3 class="font-family-alt font-weight-900 letter-spacing-2 text-uppercase xs-title-small title-medium title-sideline-base-color">
        Add Product
      </h3> </a>
    </div>
  </div>
