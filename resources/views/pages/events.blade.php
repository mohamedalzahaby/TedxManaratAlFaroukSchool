  ...
  <div class="container">
    <div class="row no-padding-rl">
      ...
      <div class="col-md-5 no-padding-rl">
        ...
        <br>
        <img src="res/images/dimensions.jpg" alt=""/>
        <br>
        <p>
          If you're a student currently studying at ManaratAlFarouk, you can register by
          filling out the form provided at the link below.
        </p>
        <p>
          The last date of registration for ManaratAlFarouk students is October 05.
        </p>
